...
def main():
    ...
    # groq_api_key = os.environ['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']
    ...
    st.write(
        "Hello! I'm your friendly Groq chatbot. I can help answer your questions, provide information, or just chat. I'm also super fast!Discover, Learn, and Master New Words Effortlessly! Let's start our conversation")
    ...
    # print_with_gap("This is a message with a managed gap.", 2)
